...
import '../../features/integrations/domain/entities/platform_cockpit_tab.dart';
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) => _pushPage(
          key: state.pageKey,
          child: PlatformIntegrationsScreen(
            initialCockpitTab: PlatformCockpitTab.fromQuery(
              state.uri.queryParameters['cockpit'],
            ),
          ),
        ),
      ),
